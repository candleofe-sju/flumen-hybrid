 ...
 * <p>
 * {@link HierarchicalMenu} is used together with {@link Route} to include it automatically
...
@Inherited
@Documented
public @interface HierarchicalMenu {

    /**
     * Index of the current menu.
     *
     * @return the index of the item in the menu.
     */
    int id() default 0;

    /**
     * Parent index of the current menu.
     *
     * @return the parent index of the item in the menu.
     */
